...
var grammar = {
  ...
  intro: {
    ...
    "goodsmallgoal": [
      ...
      "protect #goodgroup# from the threats posed by #foe2#",
    ...
    "goodbiggoal": [
      ...
      "defeat #foe2# and bring peace to the galaxy",
      "protect #pp# home planet from #badthing#",
      "bring justice to the galaxy and defeat #foegroup#",
      "rescue #friend# and end #badthing#",
      "unite the galaxy against #foegroup#",
      "restore balance to the Force and defeat #foegroup#",
      "find and destroy #badthing# to save the galaxy",
      "find and protect #friend# to defeat #foegroup#",
      "free #pp# people from the oppression of #foegroup#",
      "defend #pp# home planet from #foegroup# invasion",
      "overthrow #foe2# and restore democracy to the galaxy",
      ...
      "bring an end to #badthing# plaguing the galaxy"
    ],
    "badsmallgoal": [
      "infiltrate #goodgroup# base and steal their top-secret information",
      "kidnap #pp# leader of #goodgroup# and hold them for ransom",
    ...
    "goodthing": [
      "the promotion of PEACE and DIPLOMACY",
      "the preservation of NATURAL RESOURCES",
      "EQUALITY and JUSTICE for all species",
      ...
      "the support for EDUCATION and KNOWLEDGE",
      "the encouragement of INTERGALACTIC COOPERATION"
    ],
    "poss-pronoun":
      ["their"]
  } 
